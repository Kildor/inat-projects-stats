...
import { BooleanControlProps, FormControlCheckboxProps, FormControlProps, FormControlRadioProps, FormControlSelectProps, FormControlTaxonProps, iLookupTaxon, MultilineControlProps, NumberControlProps } from 'interfaces';
...
export const FormControlCheckbox: FunctionComponent<FormControlCheckboxProps> = ({ label, name, className, comment, onChange, checked, children }): ReactElement => {
	return (
		<label className={className}>
...
export const FormControlCSV: FunctionComponent<BooleanControlProps> = ({ handler, value }) => {
	return (
